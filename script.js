...
const linksInsta = {
    ...
    "Desgosto": "https://www.instagram.com/desgosto", // <-- O 'S' QUE ESTAVA QUEBRANDO TUDO FOI REMOVIDO DAQUI
...
// 2. OUVINTE DO CAMPO DE BUSCA (agora vai funcionar)
campoBusca.addEventListener('input', () => {
    termoBusca = campoBusca.value;
    aplicarFiltros();
});

// 3. OUVINTE DOS BOTÕES DE CATEGORIA (agora vai funcionar)
